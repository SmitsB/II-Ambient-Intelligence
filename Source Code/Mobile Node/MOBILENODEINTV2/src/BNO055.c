...
void BNO055_Suspend()
{
	BNO055_write_reg0(BNO055_PWR_MODE,0x02);
	//WRITE_REGISTER_BNO055(BNO055_PWR_MODE,0x02);
	HAL_Delay(50);
}

void BNO055_WakeUp()
{
	BNO055_write_reg0(BNO055_PWR_MODE,0x00);
	//WRITE_REGISTER_BNO055(BNO055_PWR_MODE,0x00);
	HAL_Delay(50);
}
